...
fn1 = "Z:\MIS REPORT\案件回報\未送二段原因回報_邱秀環.xlsx"
...
df = pd.read_excel("Z:\MIS REPORT\案件回報\未送二段原因回報_邱秀環.xlsx", sheet_name="H", index_col=None, header = 0,skiprows = 0)
#print(df)


df2 = pd.read_excel("Z:\MIS REPORT\案件回報\未送二段原因回報_邱秀環.xlsx", sheet_name="H回報", index_col=None, header=0, skiprows = 0)
#print(df2)
...
#print(df3)
df4.to_excel("Z:\MIS REPORT\案件回報\書翊\未送二段原因回報_邱秀環.xlsx",index = False,header = 0)

workbook = xlrd.open_workbook("Z:\MIS REPORT\案件回報\書翊\未送二段原因回報_邱秀環.xlsx")
...
df5.to_excel("Z:\MIS REPORT\案件回報\未送二段原因回報_邱秀環.xlsx",sheet_name="H",index = False)
